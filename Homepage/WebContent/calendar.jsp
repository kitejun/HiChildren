...
<body>
	<div class="container">
		...
		<img src="./images/best.png" width="100" height="100" alt="최고 도장"
			...
			class="img-rounded"> <strong>: 빨강색 도장(1개)</strong> &emsp; <img
			src="./images/bad.jpg" width="100" height="100" alt="나쁜 도장"
			class="img-rounded"> <strong>: 나쁜 도장(0개)</strong>
		<br><br>
